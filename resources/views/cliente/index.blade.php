...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <div class="row mb-4">
                <a href="{{route('cliente.create')}}" class="ver-modal btn btn-primary">Nuevo Cliente</a>
            </div>
            <table id="tabla_clientes" class="table table-hover table-responsive">
                <thead>
                    <tr>
                        <th>Nombre</th>
                        <th>Dirección</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$cliente->email}}</td>
                        <td>
                            <a href="{{route('cliente.edit',$cliente->id)}}" class="ver-modal btn btn-primary">Editar</a>
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete-{{$cliente->id}}">Eliminar</button>
                        </td>
                    </tr>
...
//Script que permite buscar en la tabla por medio de los encabazados
    $('#tabla_clientes thead tr').clone(true).appendTo( '#tabla_clientes thead' );
    $('#tabla_clientes thead tr:eq(1) th').each( function (i) {
		var title = $(this).text();
